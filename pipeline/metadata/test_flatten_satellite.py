  ...
  def test_flattenmeasurement_satellite_v1(self) -> None:
    ...
    expected = [
        ...
        Row(domain='www.ecequality.org',
            ...
            measurement_id='ab3b0ed527334c6ba988362e6a2c98fc',
            source='CP_Satellite-2020-09-02-12-00-01'),
        Row(domain='www.sportsinteraction.com',
            is_control=False,
            category='Gambling',
            ip='185.228.168.149',
            is_control_ip=False,
