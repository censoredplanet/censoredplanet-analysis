...
CREATE TEMP FUNCTION ClassifyError(error STRING,
                                   ...
                                   template_match BOOL,
                                   is_known_blockpage BOOL,
                                   blockpage_id STRING,
                                   server_header STRING) AS (
  CASE
    WHEN is_known_blockpage THEN CONCAT("content/blockpage:", blockpage_id)
...
=======
        ...
        IF(is_control_domain, "CONTROL", domain) AS domain,
        ClassifyError(GetFirstError(received_error),
                      source,
                      received_status,
                      success,
                      is_known_blockpage,
